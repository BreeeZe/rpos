...
var Camera = (function () {
    ...
    Camera.prototype.setupCamera = function () {
        ...
        v4l2ctl_1.v4l2ctl.Controls.UserControls.horizontal_flip.value = this.settings.hf;
        v4l2ctl_1.v4l2ctl.Controls.UserControls.vertical_flip.value = this.settings.vf;
        v4l2ctl_1.v4l2ctl.ApplyControls();
    };
    Camera.prototype.setSettings = function (newsettings) {
        ...
        v4l2ctl_1.v4l2ctl.Controls.CodecControls.h264_i_frame_period.value = this.settings.forceGop ? this.settings.gop : newsettings.gop;
        v4l2ctl_1.v4l2ctl.Controls.UserControls.horizontal_flip.value = !!this.settings.hf;
        v4l2ctl_1.v4l2ctl.Controls.UserControls.vertical_flip.value = !!this.settings.vf;
        v4l2ctl_1.v4l2ctl.ApplyControls();
    };
