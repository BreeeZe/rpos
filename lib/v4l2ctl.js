...
(function (v4l2ctl) {
    ...
    var UserControl = (function () {
        ...
        Object.defineProperty(UserControl.prototype, "desc", {
            get: function () {
                if (this.hasSet)
                    return this.getLookupSet().map(function (ls) { return ls.desc; })[this.value];
    ...
    function WriteToFile() {
        ...
        json = json.replace(/{"/g, "{\n\"").replace(/:{/g, ":\n{").replace(/,"/g, ",\n\"").replace(/}/g, "}\n");
        fs_1.writeFileSync("v4l2ctl.json", json);
    }
    v4l2ctl.WriteToFile = WriteToFile;
    function ReadFromFile() {
        try {
            var data = JSON.parse(fs_1.readFileSync("v4l2ctl.json").toString());
            for (var ct in data) {
